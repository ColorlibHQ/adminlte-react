...
export const metadata: Metadata = {
  title: 'Introduction',
  description: 'What @colorlib/adminlte-react is, how it is architected, and who it is for.',
}
...
export default function IntroductionPage() {
  return (
    ...
    >
      <h2>What it is</h2>
      <p>
        <code>@colorlib/adminlte-react</code> packages the AdminLTE 4 admin theme (built on Bootstrap
