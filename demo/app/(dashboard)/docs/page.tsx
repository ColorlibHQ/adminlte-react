...
export const metadata: Metadata = {
  title: 'Documentation',
  description: 'Guides and API reference for the @colorlib/adminlte-react component library.',
}
...
export default function DocsOverviewPage() {
  return (
    <DocsPage
      title="Documentation"
      lead="@colorlib/adminlte-react is an AdminLTE 4 / Bootstrap 5.3 component library built for the Next.js App Router and React Server Components."
    >
      <p>
