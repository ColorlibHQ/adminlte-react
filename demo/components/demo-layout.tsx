...
const sampleMessages = [
  { from: 'Brad Diesel', image: '/assets/img/user1-128x128.jpg', text: 'Call me whenever you can...', time: '4 Hours Ago', star: 'danger' as const },
  { from: 'John Pierce', image: '/assets/img/user8-128x128.jpg', text: 'I got your message bro', time: '4 Hours Ago', star: 'secondary' as const },
  { from: 'Nora Silvester', image: '/assets/img/user3-128x128.jpg', text: 'The subject goes here', time: '4 Hours Ago', star: 'warning' as const },
]
